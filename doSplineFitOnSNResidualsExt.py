...
if __name__ == '__main__':
    ...
    #                            independent_var, spline_type,    number of knots, minimum separation between adjacent knots, 
    ...
    #                            ]
    parameter_sets = [#['z', ['PS1MD'], 'none', 1000, 100, 'recursive_groups', 4, 0.01, -0.2, 0.2, -0.15, 0.15, 0, 0, 0, 0, 0, 0],
                      #['z', ['PS1MD'], 'none', 1000, 100, 'recursive_groups', 2, 0.01, -0.2, 0.2, -0.15, 0.15, 0, 0, 0, 0, 0, 0],
                      #['z', ['PS1MD'], 'none', 1000, 100, 'recursive_groups', 3, 0.01, -0.2, 0.2, -0.15, 0.15, 0, 0, 0, 0, 0, 0],
                      #['z', ['PS1MD'], 'none', 1000, 100, 'recursive_groups', 4, 0.01, -0.2, 0.2, -0.15, 0.15, 0, 0, 0, 0, 0, 0],
                      ['z', ['PS1MD'], 'none', 1000, 200, 'standard', 5, 0.01, -0.2, 0.2, -0.15, 0.15, 0, 0, 0, 0, 0, 0],
                      ['z', ['PS1MD'], 'none', 1000, 200, 'standard', 6, 0.01, -0.2, 0.2, -0.15, 0.15, 0, 0, 0, 0, 0, 0],
                      ['z', ['PS1MD'], 'none', 1000, 200, 'standard', 7, 0.01, -0.2, 0.2, -0.15, 0.15, 0, 0, 0, 0, 0, 0],
                      #['z', ['PS1MD'], 'none', 1000, 500, 'standard', 8, 0.01, -0.2, 0.2, -0.15, 0.15, 0, 0, 0, 0, 0, 0],
                      #['z', ['PS1MD'], 'none', 1000, 500, 'standard', 9, 0.01, -0.2, 0.2, -0.15, 0.15, 0, 0, 0, 0, 0, 0],
                      ['z', ['PS1MD'], 'none', 1000, 200, 'standard', 8, 0.01, -0.2, 0.2, -0.15, 0.15, 0, 0, 0, 0, 0, 0] ]
    saverun = 1
    run_denoter = '_spline_on_ext'
    show_best_fit = 0
    ind_var_index = 0
    data_set_index = ind_var_index + 1
    ...
    for parameter_set in parameter_sets:
        ...
        true_data_chi_sqr = simulFitMuResiduals(data_set, spline_funct, 2 * n_knots + 1, n_steps_per_param = n_burn_steps, surveys_to_fit = surveys_to_fit, param_bounds = (lower_bounds, upper_bounds),
                                                ind_variable = ind_var, diff_param_indeces_by_field = diff_param_indeces_by_field, diff_param_indeces_by_survey = diff_param_indeces_by_survey, show = 0)[0]
        random_draw_chi_sqr = []
        for i in range(n_random_draws):
            print '!!!!!!STARTING NEW RANDOM DRAW: ' + str(i) + ' OF ' + str(n_random_draws) + '!!!!!!'
