...
if __name__ == '__main__':
    ...
    #                            ]
    parameter_sets = [#[1, ['PS1MD'], 'none', 1000, 100, 'recursive_groups', 4, 0.01, -0.2, 0.2, -0.15, 0.15, 0, 0, 0, 0, 0, 0],
                      #[1, ['PS1MD'], 'none', 1000, 100, 'recursive_groups', 2, 0.01, -0.2, 0.2, -0.15, 0.15, 0, 0, 0, 0, 0, 0],
                      #[1, ['PS1MD'], 'none', 1000, 100, 'recursive_groups', 3, 0.01, -0.2, 0.2, -0.15, 0.15, 0, 0, 0, 0, 0, 0],
                      #[1, ['PS1MD'], 'none', 1000, 100, 'recursive_groups', 4, 0.01, -0.2, 0.2, -0.15, 0.15, 0, 0, 0, 0, 0, 0],
                      #[1, ['PS1MD'], 'none', 1000, 100, 'recursive_groups', 5, 0.01, -0.2, 0.2, -0.15, 0.15, 0, 0, 0, 0, 0, 0],
                      #[1, ['PS1MD'], 'none', 1000, 100, 'recursive_groups', 6, 0.01, -0.2, 0.2, -0.15, 0.15, 0, 0, 0, 0, 0, 0],
                      #[1, ['PS1MD'], 'none', 1000, 100, 'recursive_groups', 7, 0.01, -0.2, 0.2, -0.15, 0.15, 0, 0, 0, 0, 0, 0],
                      #[1, ['PS1MD'], 'none', 1000, 100, 'recursive_groups', 8, 0.01, -0.2, 0.2, -0.15, 0.15, 0, 0, 0, 0, 0, 0],
                      #[1, ['all'], 'none', 10000, 2, 'standard', 7, 0.01, -0.2, 0.2, -0.15, 0.15, 1, 0, 0, 0, 0, 0],
                      [1, ['all'], 'none', 10000, 500, 'standard', 7, 0.01, -0.2, 0.2, -0.15, 0.15, 1, 0, 0, 0, 0, 0] ]
    saverun = 1
    run_denoter = '_spline_7_allSurveys'
    show_best_fit = 0
    data_set_index = 0
    ...
    for parameter_set in parameter_sets:
        ...
        sig_sqr_results[set_index] = [n_knots, true_data_best_fit_params, true_data_chi_sqr, random_draw_chi_sqr]
