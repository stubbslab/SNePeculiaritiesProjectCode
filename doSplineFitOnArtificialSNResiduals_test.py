...
if __name__ == '__main__':
    ...
    parameter_sets = [#[1, 'real', 'extinction', ['PS1MD'], 'none', 1000, 100, 'recursive_groups', 4, 0.01, -0.2, 0.2, -0.15, 0.15, 0, 0, 0, 0, 0, 0],
                      ...
                      #[1, 'art_funct', 'extinction', ['PS1MD'], 'none', 1000, 100, 'standard', 4, 0.01, -0.5, 0.5, -0.15, 0.15, 0, 0, 0, 0, 0, 0],
                      [4, 'art_funct', 't', ['all'], 'none', 2000, 1, 5,  'standard', 4, 1.0, -0.5, 0.5, -0.15, 0.15, 0, 0, 0, 0, 0, 0]
                      #[4, 'art_funct', 't', ['all'], 'none', 2000, 200, 200,  'standard', 5, 1.0, -0.5, 0.5, -0.15, 0.15, 0, 0, 0, 0, 0, 0],
                      #[4, 'art_funct', 't', ['all'], 'none', 2000, 200, 200,  'standard', 6, 1.0, -0.5, 0.5, -0.15, 0.15, 0, 0, 0, 0, 0, 0],
                      #[4, 'art_funct', 't', ['all'], 'none', 2000, 200, 200,  'standard', 7, 1.0, -0.5, 0.5, -0.15, 0.15, 0, 0, 0, 0, 0, 0],
                      #[4, 'art_funct', 't', ['all'], 'none', 2000, 200, 200,  'standard', 8, 1.0, -0.5, 0.5, -0.15, 0.15, 0, 0, 0, 0, 0, 0],
                      #[4, 'art_funct', 't', ['all'], 'none', 2000, 200, 200,  'standard', 9, 1.0, -0.5, 0.5, -0.15, 0.15, 0, 0, 0, 0, 0, 0],
                      #[4, 'art_funct', 't', ['all'], 'none', 2000, 200, 200,  'standard', 10, 1.0, -0.5, 0.5, -0.15, 0.15, 0, 0, 0, 0, 0, 0],
                      #[4, 'art_funct', 't', ['all'], 'none', 2000, 200, 200,  'standard', 11, 1.0, -0.5, 0.5, -0.15, 0.15, 0, 0, 0, 0, 0, 0],
                      #[4, 'art_funct', 't', ['all'], 'none', 2000, 200, 200,  'standard', 12, 1.0, -0.5, 0.5, -0.15, 0.15, 0, 0, 0, 0, 0, 0] 
                     ]
    ...
    saverun = 1
    run_denoter = 'spline_vs_artificialResids_in_t_true_and_rand_data_3'
    show_best_fit = 0
    data_set_index = 0
    ...
    for parameter_set in parameter_sets:
        ...
        for random_sample in range(n_random_draws):
            ...
            random_draw_chi_sqr, rand_data_best_fit_params = random_draw_chi_sqr + [simulFitMuResiduals(data_set, spline_funct, 2 * n_knots + 1,
                                                                                                        data_set_type = data_set_type, n_steps_per_param = n_burn_steps,
                                                                                                        surveys_to_fit = surveys_to_fit, ind_variable= ind_var,
                                                                                                        param_bounds = (lower_bounds, upper_bounds), 
                                                                                                        diff_param_indeces_by_field = diff_param_indeces_by_field, 
