...
if __name__ == '__main__':
    #parameters at present are: [data_set, ind_variable, surveys to fit, archive to determine fields, n_burn_in_steps, number_random_draws,
    ...
    parameter_sets = [#[1, 'extinction', ['PS1MD'], 'none', 1000, 100, 'recursive_groups', 4, 0.01, -0.2, 0.2, -0.15, 0.15, 0, 0, 0, 0, 0, 0],
                      ...
                      #[1, 'extinction', ['all'], 'none', 100, 20, 'standard', 3, 0.01, -0.2, 0.2, -0.15, 0.15, 1, 0, 0, 0, 0, 0],
                      [1, 'extinction', ['all'], 'none', 300, 500, 'standard', 4, 0.01, -0.2, 0.2, -0.15, 0.15, 1, 0, 0, 0, 0, 0],
                      [1, 'extinction', ['all'], 'none', 300, 500, 'standard', 5, 0.01, -0.2, 0.2, -0.15, 0.15, 1, 0, 0, 0, 0, 0],
                      [1, 'extinction', ['all'], 'none', 300, 500, 'standard', 6, 0.01, -0.2, 0.2, -0.15, 0.15, 1, 0, 0, 0, 0, 0],
                      [1, 'extinction', ['all'], 'none', 300, 500, 'standard', 7, 0.01, -0.2, 0.2, -0.15, 0.15, 1, 0, 0, 0, 0, 0],
                      [1, 'extinction', ['all'], 'none', 300, 500, 'standard', 8, 0.01, -0.2, 0.2, -0.15, 0.15, 1, 0, 0, 0, 0, 0] ]
    saverun = 1
    run_denoter = 'extinction_spline_allSurveys'
    show_best_fit = 0
    data_set_index = 0
