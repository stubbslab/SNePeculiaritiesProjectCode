...
if __name__ == '__main__':
    ...
    parameter_sets = [#[1, 'extinction', ['PS1MD'], 'none', 1000, 100, 'recursive_groups', 4, 0.01, -0.2, 0.2, -0.15, 0.15, 0, 0, 0, 0, 0, 0],
                      ...
                      [1, 'z', ['all'], 'none', 10000, 100, 0, 'standard', 4, 0.01, -0.2, 0.2, -0.15, 0.15, 1, 0, 0, 0, 0, 0],
                      [1, 'z', ['all'], 'none', 10000, 100, 0, 'standard', 5, 0.01, -0.2, 0.2, -0.15, 0.15, 1, 0, 0, 0, 0, 0],
                      [1, 'z', ['all'], 'none', 10000, 100, 0, 'standard', 6, 0.01, -0.2, 0.2, -0.15, 0.15, 1, 0, 0, 0, 0, 0],
                      [1, 'z', ['all'], 'none', 10000, 100, 0, 'standard', 7, 0.01, -0.2, 0.2, -0.15, 0.15, 1, 0, 0, 0, 0, 0],
                      [1, 'z', ['all'], 'none', 10000, 100, 0, 'standard', 8, 0.01, -0.2, 0.2, -0.15, 0.15, 1, 0, 0, 0, 0, 0],
                      [1, 'z', ['all'], 'none', 10000, 100, 0, 'standard', 9, 0.01, -0.2, 0.2, -0.15, 0.15, 1, 0, 0, 0, 0, 0],
                      [1, 'z', ['all'], 'none', 10000, 100, 0, 'standard', 10, 0.01, -0.2, 0.2, -0.15, 0.15, 1, 0, 0, 0, 0, 0],
                      [1, 'z', ['all'], 'none', 10000, 100, 0, 'standard', 11, 0.01, -0.2, 0.2, -0.15, 0.15, 1, 0, 0, 0, 0, 0] ]
    saverun = 0
    run_denoter = 'spline_vs_res_allSurveys_redrawTrueSample'
    show_best_fit = 0
    data_set_index = 0
