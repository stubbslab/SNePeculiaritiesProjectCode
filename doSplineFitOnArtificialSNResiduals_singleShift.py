...
if __name__ == '__main__':
    ...
    parameter_sets = [#[1, 'real', 'extinction', ['PS1MD'], 'none', 1000, 100, 'recursive_groups', 4, 0.01, -0.2, 0.2, -0.15, 0.15, 0, 0, 0, 0, 0, 0],
                      ...
                      [5, 'art_funct', 't', ['all'], 'none', 2000, 200, 200,  'standard', 4, 1.0, -0.5, 0.5, -0.15, 0.15, 0, 0, 0, 0, 0, 0],
                      [5, 'art_funct', 't', ['all'], 'none', 2000, 200, 200,  'standard', 5, 1.0, -0.5, 0.5, -0.15, 0.15, 0, 0, 0, 0, 0, 0],
                      [5, 'art_funct', 't', ['all'], 'none', 2000, 200, 200,  'standard', 6, 1.0, -0.5, 0.5, -0.15, 0.15, 0, 0, 0, 0, 0, 0],
                      [5, 'art_funct', 't', ['all'], 'none', 2000, 200, 200,  'standard', 7, 1.0, -0.5, 0.5, -0.15, 0.15, 0, 0, 0, 0, 0, 0],
                      [5, 'art_funct', 't', ['all'], 'none', 2000, 200, 200,  'standard', 8, 1.0, -0.5, 0.5, -0.15, 0.15, 0, 0, 0, 0, 0, 0],
                      [5, 'art_funct', 't', ['all'], 'none', 2000, 200, 200,  'standard', 9, 1.0, -0.5, 0.5, -0.15, 0.15, 0, 0, 0, 0, 0, 0],
                      [5, 'art_funct', 't', ['all'], 'none', 2000, 200, 200,  'standard', 10, 1.0, -0.5, 0.5, -0.15, 0.15, 0, 0, 0, 0, 0, 0],
                      [5, 'art_funct', 't', ['all'], 'none', 2000, 200, 200,  'standard', 11, 1.0, -0.5, 0.5, -0.15, 0.15, 0, 0, 0, 0, 0, 0],
                      [5, 'art_funct', 't', ['all'], 'none', 2000, 200, 200,  'standard', 12, 1.0, -0.5, 0.5, -0.15, 0.15, 0, 0, 0, 0, 0, 0] 
                     ]
    ...
    saverun = 1
    run_denoter = 'spline_vs_artificialZerod1Resids_in_t_true_and_rand_data_singleShift'
    show_best_fit = 0
    data_set_index = 0
