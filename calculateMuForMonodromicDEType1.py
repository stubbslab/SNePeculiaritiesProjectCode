...
def getMonodromicDECosmologyWithProperOmL(A, nu, alpha, initial_a_s, phi0_power_bounds, 
                                          t0 = None, tau0 = None, 
    ...
    funct_to_minimize = lambda phi0_power: abs(ResidualMuCalculatorForMonodromicDE(A, nu, alpha, initial_a_s, t0 = t0, tau0 = tau0, phi0 = 10.0 ** phi0_power, canon_mus = canon_mus, OmM0 = OmM0, OmL0 = OmL0, OmR0 = OmR0, Om0 = Om0, H0 = H0, H0_units = H0_units, dL_units = dL_units).rhoDE_of_a[-1] - target_OmL0)
    ...
    return ResidualMuCalculatorForMonodromicDE(A, nu, alpha, initial_a_s, t0 = t0, tau0 = tau0, phi0 = 10.0 ** best_fit_phi0_power, canon_mus = canon_mus, OmM0 = OmM0, OmL0 = OmL0, OmR0 = OmR0, Om0 = Om0, H0 = H0, H0_units = H0_units, dL_units = dL_units)


class ResidualMuCalculatorForMonodromicDE: 
